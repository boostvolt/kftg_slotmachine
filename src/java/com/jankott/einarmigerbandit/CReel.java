...
public class CReel {
    ...
    private final CSymbol seven = new CSymbol(7, "src/resources/symbols/seven.png");
    private final CSymbol bell = new CSymbol(6, "src/resources/symbols/bell.png");
    private final CSymbol grape = new CSymbol(5, "src/resources/symbols/grape.png");
    private final CSymbol strawberry = new CSymbol(4, "src/resources/symbols/strawberry.png");
    private final CSymbol coin = new CSymbol(3, "src/resources/symbols/coin.png");
    private final CSymbol cherry = new CSymbol(2, "src/resources/symbols/cherry.png");
